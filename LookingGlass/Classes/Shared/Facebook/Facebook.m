...
- (NSString *)getOwnBaseUrl {
  return [NSString stringWithFormat:@"fb%@%@://authorize", _appId, _urlSchemeSuffix ? _urlSchemeSuffix : @""];
}
                    ...
                    safariAuth:(BOOL)trySafariAuth 
{
  ...
  NSString *loginDialogURL = [kDialogBaseURL stringByAppendingString:kLogin];
    ...
    //NSLog(@"loginDialogURL: %@", loginDialogURL);
  ...
  if (_urlSchemeSuffix) {
    ...
    //NSLog(@"_urlSchemeSuffix: %@", self.urlSchemeSuffix);
